    ...
    def move(self):
        while True:
            ...
            if ask in moves:
                ...
                print(Fore.RED + Back.YELLOW + "THAT'S NOT A VALID MOVE! "
                      "PLEASE TRY AGAIN!\n")
...
class Game:
    ...
    def play_round(self):
        ...
        move2 = self.p2.move()
        print(Fore.RED +
              f"YOUR MOVE: {move1}", "VS",
              Fore.BLUE +
              f"OPPONENT MOVE: {move2}")

        if beats(move1, move2) is True:
            print(Fore.RED + Back.WHITE + "YOU WIN!")
            p1.score += 1
            print(f"YOUR SCORE: {p1.score} | OPPONENT SCORE: {p2.score}\n")
        elif move1 == move2:
            print(Fore.GREEN + Back.WHITE + "IT'S A TIE!")
            print(f"YOUR SCORE: {p1.score} | OPPONENT SCORE: {p2.score}\n")
        else:
            print(Fore.BLUE + Back.WHITE + "OPPONENT WINS!")
            p2.score += 1
            print(f"YOUR SCORE: {p1.score} | OPPONENT SCORE: {p2.score}\n")
    ...
    def play_game(self):
        ...
        if p1.score > p2.score:
            print("FINAL SCORE:\n")
            print(Fore.RED + f"YOU > {p1.score}")
            print(Fore.BLUE + f"OPPONENT > {p2.score}\n")
            ...
            print(Fore.RED + f"YOU > {p1.score}")
            print(Fore.BLUE + f"OPPONENT > {p2.score}\n")
            print(Fore.YELLOW + Style.BRIGHT + "----YOU LOSE THE GAME----")
